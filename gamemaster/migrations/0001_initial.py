# Generated by Django 3.1.2 on 2020-10-09 20:44
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('idle_timeout', models.FloatField(default=90)),
        ...
        migrations.CreateModel(
            name='NLHERoom',
            fields=[
                ('pokerroom_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='gamemaster.pokerroom')),
            ],
            options={
